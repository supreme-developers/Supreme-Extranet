        ...
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            <script type="text/javascript">
                ...
                function AddNew(sender, args) {
                    window.location = 'CertificateofCompliance_dev.aspx';
                }
                                                            ...
                                                            <asp:Panel ID="Panel1" runat="server">
                                                                <table style="width: 100%">
                                                                    <tr>
                                                                        ...
                                                                        <td align="left">
                                                                            <telerik:RadComboBox ID="RadComboBoxInspectMeth" runat="server" DataSourceID="SqlDataSourceInspectMeth"
                                                                                DataTextField="MethodofInspection" DataValueField="MethodofInspectionID" EmptyMessage="Select Inspection Method"
                                                            ...
                                                            <asp:Panel ID="Panel2" runat="server">
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td align="left">
                                                                            <telerik:RadComboBox ID="RadComboBoxSpecNum" runat="server" DataSourceID="SqlDataSourceSpecNum"
                                                                                DataTextField="SpecificationNumber" DataValueField="SpecificationNumberID" EmptyMessage="Select a Spectification #"
                                                                                EnableAutomaticLoadOnDemand="true">
                                                                            </telerik:RadComboBox>
                                                    ...
                                                    <tr>
                                                        <td align="center" colspan="2">
                                                            <telerik:RadButton ID="RadButtonStep1Next" runat="server" Text="Next" OnClick="RadButtonStep1Next_Click"
                                                                ValidationGroup="Step1" CausesValidation="true" UseSubmitBehavior="false">
                                                                        ...
                                                                        <asp:Panel ID="Panel2" runat="server" Width="100%">
                                                                            <table>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="left">
                                                                                        <telerik:RadDatePicker ID="RadDateManDate"  runat="server" style="display:" DateInput-EmptyMessage="Manufacture Date" >
                                ...
                                <center>
                                    <div id="slide_00" class="slide">
                                        <asp:Panel ID="PanelPadeyes" runat="server" BackColor="White" Width="100%">
                                            ...
                                            <hr style="height: 4; width: 100%; background-color: Black;" color="Black" class="bigLine" />
                                            <table>
                                                <tr>
                ...
                <table style="display: ">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <telerik:RadButton ID="RadButtonCreateNew" runat="server" Text="New Cert" AutoPostBack="true" OnClientClicked="AddNew" >
